(function (opts_) {
    ...
    if (M()) {
        document
            ...
            .appendChild(
                O(
                    opts_.cselibVersion
                        ? u(K, { versionDir: opts_.cselibVersion, versionSlash: L, experiment: opts_.uiOptions.cssThemeVersion && 4 !== opts_.uiOptions.cssThemeVersion ? "_v" + opts_.uiOptions.cssThemeVersion : "", lang: opts_.language })
    ...
    cse_token: "AB-tC_49YuR8P-eiUhLXQaQHERO3:1699951632652",
    isHostedPage: false,
    exp: ["csqr", "cc", "pos"],
